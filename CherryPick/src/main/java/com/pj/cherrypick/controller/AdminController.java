...
public class AdminController {
	...
	public void getListPage(@AuthenticationPrincipal PrincipalDetail principalDetail, Model model, @RequestParam("num") int num, @RequestParam("sort") String sort,
		...
		if(principalDetail.getUsername().equals(adminService.getAdminUsername())) {
			Page page = new Page();
			page.setNum(num);
