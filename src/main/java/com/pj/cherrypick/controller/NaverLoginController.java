...
public class NaverLoginController {
  ...
  private String CLIENT_ID = "p4kc2NLMVYKeWAzO48Br"; //애플리케이션 클라이언트 아이디값";
  private String CLI_SECRET = "kQwgQytyjp"; //애플리케이션 클라이언트 시크릿값";
  ...
  public String testNaver(HttpSession session, Model model) throws UnsupportedEncodingException, UnknownHostException {
    ...
    String redirectURI = URLEncoder.encode("http://localhost/naver/callback1", "UTF-8");
